<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ConsultaSuplidor.aspx.cs" Inherits="WebVentas.Consultas.ConsultaSuplidor" %>


<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <fieldset class="container">
        <h1><strong>Consulta De Suplidor </strong></h1>
        <div class="progress">
     ...
     <div class="row 50%">
    <div>
        <asp:GridView ID="GridViewSuplidor" runat="server" class="bg-primary" CellPadding="4" ForeColor="#333333" GridLines="None" Width="961px" >
