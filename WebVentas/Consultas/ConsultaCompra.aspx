<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ConsultaCompra.aspx.cs" Inherits="WebVentas.Consultas.ConsultaCompra" %>

<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <fieldset class="container">
        <h1><strong>Consulta De Compra </strong></h1>
        <div class="progress">
     ...
     <div class="row 50%">
    <div>
        <asp:GridView ID="GridViewCompra" runat="server" class="bg-primary" CellPadding="4" ForeColor="#333333" GridLines="None" Width="961px" >
