...
namespace WebVentas.Consultas
{
    public partial class ConsultaUsuario : System.Web.UI.Page
    {
        ...
        public string Mostrar()
        {
            ...
            GridViewUsuario.DataSource = usuario.Listado("usuario.IdUsuario as IdUsuario, Nombre, Apellido, Correo, Contraseña, NombreUsuario", "IdUsuario = " + TextBoxBuscar.Text, "");
